...
def _create_pre_migration_db(path: str) -> sqlite3.Connection:
    ...
    conn.execute("""
        CREATE TABLE files (
            ...
            status TEXT DEFAULT 'listed', status_reason TEXT, status_changed_at DATETIME,
    ...
    conn.execute("""
        CREATE TABLE folders (
            ...
            status TEXT DEFAULT 'listed', indexed_at DATETIME DEFAULT CURRENT_TIMESTAMP,
            client_id INTEGER,
    ...
    conn.execute("""
        CREATE TABLE projects (
            ...
            project_type TEXT, status TEXT DEFAULT 'listed',
            created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
    ...
    conn.execute("""
        CREATE TABLE clients (
            ...
            status TEXT DEFAULT 'listed', created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
            metadata TEXT,
            mcp_read TEXT DEFAULT 'inherit', mcp_view TEXT DEFAULT 'inherit',
    ...
    conn.execute("""
        CREATE TABLE emails (
            ...
            indexed_at DATETIME DEFAULT CURRENT_TIMESTAMP,
            metadata TEXT, status TEXT DEFAULT 'listed',
            mcp_read TEXT DEFAULT 'inherit', mcp_view TEXT DEFAULT 'inherit',
            summary TEXT,
            client_id INTEGER, project_id INTEGER,
            created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
